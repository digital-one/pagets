...
if ( ! class_exists( 'WP_Widget_Black_Studio_TinyMCE' ) ) {
	...
	class WP_Widget_Black_Studio_TinyMCE extends WP_Widget {
		...
		public function __construct() {
			...
			$widget_title = __( 'Pagets :: Signpost Box', 'black-studio-tinymce-widget' );
		...
		public function widget( $args, $instance ) {
			...
			$default_html = '<div class="box keyline"><h4>Heading</h4><p>Box content</p><p><a href="#" class="full-width button">Find out more</a></p></div>';
			...
			//if($text=="") $text='<div class="box keyline"><h4>Heading</h4><p>Box content</p><p><a href="#" class="full-width button">Find out more</a></p></div>';
			if ( ! ( $hide_empty && empty( $text ) ) ) {
				...
				$output .= $before_text . 'eeeee' . $text . $after_text;
				$output .= $after_widget;
				echo $output; // xss ok
